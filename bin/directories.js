...
export function getDestinationPaths(engineName) {
    ...
    return {
        ...
        hooks: {
            ...
            create: CWD + `/src/engines/${engineName}/hooks/useCreate${EngineName}.ts`,
            get: CWD + `/src/engines/${engineName}/hooks/useGet${EngineName}.ts`,
            all: CWD + `/src/engines/${engineName}/hooks/useGet${EngineName}s.ts`,
            update: CWD + `/src/engines/${engineName}/hooks/useUpdate${EngineName}.ts`,
        },
